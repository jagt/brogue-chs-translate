...
extern BROGUE_DISPLAY *brogue_display;
extern BROGUE_DRAW_COLOR windowColor;
extern BROGUE_DRAW_COLOR inputFieldColor;
extern tcell tmap[DCOLS][DROWS];						// grids with info about the map
extern lightcorner lightmap[DCOLS + 1][DROWS + 1];
