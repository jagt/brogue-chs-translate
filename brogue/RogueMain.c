...
//        copyDisplayBuffer(dbuf, displayBuffer);
	...
	BrogueDrawContext_drawAsciiString(context, 0, 0, displayedMessage[0]);
	...
	BrogueDrawContext_drawAsciiString(context, 70, 2, buf);
